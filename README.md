...
const App = () => {
  ...
  return (
    <div className="calculator">
      ...
      <footer>
        <p>DEVELOPED BY GURU PRASATH R</p>
        <p>Reg No: 212223040053</p> 
      </footer>
...
## OUTPUT
![Screenshot 2025-05-01 214532](https://github.com/user-attachments/assets/4bc2016c-e22f-4ed6-b5b8-abd6864056cb)
